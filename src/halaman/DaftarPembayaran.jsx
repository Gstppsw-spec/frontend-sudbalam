...
// export default class DaftarPembayaran extends Component {
...
//     if (prevProps.sameProp !== this.props.sameProp) {
//       // const token = localStorage.getItem("token");
//       // this.fetch("https://subdomain.sudbalam.com/api/dataterima", {
//       //   headers: {
//       //     Authorization: `Bearer ${token}`,
//       //   },
//       // })
...
//       }
//       this.state.navigate(
//         `/datapembayaran/datapembayaran/editPembayaran/${id}/${nik_alm}`
//       );
//       console.log(nik_alm);
//       console.log(id);
//     };
...
//     const numberedData = this.state.data.map((item, index) => {
//       return { ...item, no: getNumber(index) };
//     });
...
//     if (this.state.error) {
//       return <div>ErrorL {this.state.error.message}</div>;
